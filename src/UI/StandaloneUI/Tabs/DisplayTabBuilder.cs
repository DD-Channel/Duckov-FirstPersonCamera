...
namespace FirstPersonCamera.StandaloneUI.Tabs
{
    internal static class DisplayTabBuilder
    {
            ...
            Dictionary<string, Button> keybindButtons)
        {
            ...
            StandaloneUICreator.CreateToggleRow(parent, "隐藏护甲", OptionsUIConstants.HideArmorKey, true, toggles);
            ...
            StandaloneUICreator.CreateToggleRow(parent, "身体显示隐藏", OptionsUIConstants.HideRightHandKey, false, toggles);
            StandaloneUICreator.CreateDivider(parent);
