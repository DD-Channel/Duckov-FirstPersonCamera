...
public class IndexController {
	...
	@Resourceprivate FangwuxinxiServer fangwuxinxiServer;@Resourceprivate HetongxinxiServer hetongxinxiServer;
...
//	首页显示内容
	...
	public String showIndex(ModelMap map){
		...
		List<Fangwuxinxi> syfangwuxinxi=fangwuxinxiServer.getsyfangwuxinxi1(null);List<Hetongxinxi> syhetongxinxi=hetongxinxiServer.getsyhetongxinxi1(null);
	    ...
	    map.put("syfangwuxinxi", syfangwuxinxi);map.put("syhetongxinxi", syhetongxinxi);
